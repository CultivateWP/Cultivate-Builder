...
function cwp_gutenberg_scripts() {
	wp_enqueue_script( 'theme-editor', get_theme_file_uri( '/assets/js/editor.js' ), array( 'wp-blocks', 'wp-dom', 'lodash' ), filemtime( get_theme_file_path( '/assets/js/editor.js' ) ), true );
}
